...
echo "\" https://docs.abinit.org/guide/abinit/#physical-information" >> "$vimdir/syntax/abi.vim"
echo "syntax keyword energy_unit Ha Hartree eV meV Rydbergs Rydberg Ry K Kelvin" >> "$vimdir/syntax/abi.vim"
echo "syntax keyword length_unit Bohr nm Ang Angstr Angstrom" >> "$vimdir/syntax/abi.vim"
echo "syntax keyword mag_unit T Tesla" >> "$vimdir/syntax/abi.vim"
echo "syntax keyword time_unit as asec asecond ps psec psecond" >> "$vimdir/syntax/abi.vim"
echo "highlight! link energy_unit Type" >> "$vimdir/syntax/abi.vim"
echo "highlight! link length_unit Type" >> "$vimdir/syntax/abi.vim"
echo "highlight! link time_unit Type" >> "$vimdir/syntax/abi.vim"
echo "highlight! link mag_unit Type" >> "$vimdir/syntax/abi.vim"
